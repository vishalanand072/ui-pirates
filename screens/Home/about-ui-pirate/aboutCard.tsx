    ...
    <Card className="shadow-lg" style={{
      ...
      <CardHeader className="flex flex-col">
        <div className="flex-shrink-0" style={{ alignSelf: 'flex-start' }}>
          <video width="600px" height="320px" controls preload="none" style={{ borderRadius: '999px' }}>
      ...
      <CardBody className="flex flex-col gap-4" style={{ paddingTop: '40px' }}>
        ...
        <div className="flex flex-col" style={{ marginTop: 'auto', paddingBottom: '40px' }}>
