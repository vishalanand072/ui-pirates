...
<div className="relative flex h-screen items-center justify-center overflow-hidden bg-background p-0 m-0 md:shadow-xl">
    <div className="flex flex-col items-center justify-center">
        ...
        <div className="layer relative">
            <div className="absolute text-center z-20 w-full h-2/6" style={{ top: '44%', left: '50%', transform: 'translate(-50%, -50%)',         background: 'linear-gradient(to bottom, white 40%, rgba(255, 255, 0, 0) 100%)' }}>
                <h1 className="text-6xl md:text-5xl font-bold text-white-900 p-6">What People Are Saying</h1>
